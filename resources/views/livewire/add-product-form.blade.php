<section class="bg-white">
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <h2 class="mb-4 text-xl font-bold text-gray-900">Agregar nuevo producto</h2>
      <form wire:submit.prevent="save">
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div class="sm:col-span-2">
                    @if ($product_image) 
						<img src="{{ $product_image->temporaryUrl() }}" alt="Product image" height="300px" width="300px" class="rounded-lg">
					@else
